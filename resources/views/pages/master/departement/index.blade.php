...
@section('content')
    ...
    @include('pages.master.departement.components.add')
    @include('pages.master.departement.components.edit')
@endsection
        ...
        $(function() {
            ...
            $(document).on('click', '#deleteButton', function(e) {
                ...
                t.fire({
                    ...
                    e.value && $.ajax({
                        url: "{{ route('departements.destroy', '') }}" + '/' + id,
                        type: "DELETE",
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
